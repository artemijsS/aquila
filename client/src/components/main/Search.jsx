...
function Search ({ data, onCreate, newData }) {
    ...
    return (
        <div className="search">
            ...
            <input type="text" placeholder="Search" disabled={newData}/>
            <svg onClick={() => onPlus()} className={data.length !== 0 ? "plus" : "plus pulse"} width="30" height="30" viewBox="0 0 480 480" xmlns="http://www.w3.org/2000/svg" ><title>plus</title><path d="M220 400l40 0 0-140 140 0 0-40-140 0 0-140-40 0 0 140-140 0 0 40 140 0 0 140z" /></svg>
        </div>
    )
}
